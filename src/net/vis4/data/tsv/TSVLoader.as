package net.vis4.data.tsv 
{
	...
	public class TSVLoader extends DataLoader 
	{
		/** @private **/
		private static var _classActivated:Boolean = _activateClass("TSVLoader", DataLoader, "tsv,csv");
		/** @private **/
		 ...
		 */
		public function TSVLoader(urlOrRequest:*, vars:Object=null) {
		...
		override protected function _receiveDataHandler(event:Event):void {
			var data:Array = TSVParser.parse(_loader.data, true);
			_content = data;
